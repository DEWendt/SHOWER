...
# and return lines (82 and 83) to have a fully functional script.

S4_CAMELS_KarsticModule = function(P, PET, D, par){
  ...
  #Second groundwater run 
    source(paste0(Localrepo,'Karst_Scenario4_EcologicalFlow_function.r')) ## Groundwater run with the ecological flow implemented
  GS_S4=GW_karst_S4Eco(par=par, soilmoisture = SS_run,
