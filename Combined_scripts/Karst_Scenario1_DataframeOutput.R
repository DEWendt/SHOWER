...
# and return lines (117 and 118) to have a fully functional script.

S1_CAMELS_KarsticModule=function(P, PET, D, par){
  ...
  D_GW1 =c(0.04, 0.11, 0.23)                                        # Groundwater use is set to increase following these percentages
  ...
  GS_S1=GW_karst_Scenario12(par=par, soilmoisture = SS_run,         # Groundwater run with scenario 1 implemented
                     D_GW=TD_GW,D_S = D_GW1, 
  ...
  WRR_L=Res_S12(K=ResCAP,GS=GS_S1,D_SW = TD_SW,
