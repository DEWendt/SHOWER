...
Res_S12 = function(ResCAP, GS, D_SW,SPI,D_S){
  ...
  for(t in 1:(length(GS$Rch)-1)){
    GS$Res[t+1]=GS$Res[t]-GS$D_swDMP[t] +GS$Qr[t]+GS$Qres[t]+GS$Qimp[t] # Reservoir storage with incoming Qr, QRes, Imported SW and outgoing D_swDMP
